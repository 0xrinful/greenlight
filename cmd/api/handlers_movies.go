...
func (app *application) createMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	err = app.renderJSON(w, http.StatusCreated, envelope{"movie": movie}, headers)
	if err != nil {
		app.sendServerError(w, r, err)
	}
}
...
func (app *application) deleteMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	err = app.renderJSON(w, http.StatusOK, envelope{"message": "movie successfully deleted"}, nil)
	if err != nil {
		app.sendServerError(w, r, err)
	}
}
...
func (app *application) listMoviesHandler(w http.ResponseWriter, r *http.Request) {
	...
	err = app.renderJSON(w, http.StatusOK, envelope{"movies": movies, "metadata": metadata}, nil)
	if err != nil {
		app.sendServerError(w, r, err)
	}
}
